...
void CONFIG_LoadProperties_v1(void) {
    ...
    UDS_FrontLight_Properties.AutomaticDiagnostics = mem->properties.AutomaticDiagnostics;
    UDS_FrontLight_Properties.BrightnessCurve_Cutoff_X = mem->properties.BrightnessCurve_Cutoff_X;
    UDS_FrontLight_Properties.BrightnessCurve_Cutoff_Y = mem->properties.BrightnessCurve_Cutoff_Y;
    UDS_FrontLight_Properties.BrightnessCurve_Max_X = mem->properties.BrightnessCurve_Max_X;
    UDS_FrontLight_Properties.BrightnessCurve_Max_Y = mem->properties.BrightnessCurve_Max_Y;
    UDS_FrontLight_Properties.Brightness_LevelStandard = mem->properties.Brightness_LevelStandard;
    UDS_FrontLight_Properties.Brightness_LevelEmergency = mem->properties.Brightness_LevelEmergency;
    UDS_FrontLight_Properties.Brightness_LevelSafety = mem->properties.Brightness_LevelSafety;
    UDS_FrontLight_Properties.Strobe_LevelLow = mem->properties.Strobe_LevelLow;
    UDS_FrontLight_Properties.Strobe_LevelHigh = mem->properties.Strobe_LevelHigh;
    UDS_FrontLight_Properties.Strobe_ModeDefault = CONFIG_ConvertStrobeConfigToUds(mem->properties.Strobe_ModeDefault);
    UDS_FrontLight_Properties.Strobe_ModePrimary = CONFIG_ConvertStrobeConfigToUds(mem->properties.Strobe_ModePrimary);
    UDS_FrontLight_Properties.Strobe_ModeEmergency = CONFIG_ConvertStrobeConfigToUds(mem->properties.Strobe_ModeEmergency);
    UDS_FrontLight_Properties.Strobe_ModeSafety = CONFIG_ConvertStrobeConfigToUds(mem->properties.Strobe_ModeSafety);
    UDS_FrontLight_Properties.Strobe_SingleOnTime = mem->properties.Strobe_SingleOnTime;
    UDS_FrontLight_Properties.Strobe_SingleOffTime = mem->properties.Strobe_SingleOffTime;
    UDS_FrontLight_Properties.Strobe_RapidOnTime = mem->properties.Strobe_RapidOnTime;
    UDS_FrontLight_Properties.Strobe_RapidOffTime = mem->properties.Strobe_RapidOffTime;
}
...
void CONFIG_Reload(void) {
    CONFIG_Props.AutomaticDiagnostics = UDS_FrontLight_Properties.AutomaticDiagnostics;
    CONFIG_Props.BrightnessCurve_Cutoff_X = UDS_FrontLight_Properties.BrightnessCurve_Cutoff_X;
    CONFIG_Props.BrightnessCurve_Cutoff_Y = UDS_FrontLight_Properties.BrightnessCurve_Cutoff_Y;
    CONFIG_Props.BrightnessCurve_Max_X = UDS_FrontLight_Properties.BrightnessCurve_Max_X;
    CONFIG_Props.BrightnessCurve_Max_Y = UDS_FrontLight_Properties.BrightnessCurve_Max_Y;
    CONFIG_Props.Brightness_LevelStandard = UDS_FrontLight_Properties.Brightness_LevelStandard;
    CONFIG_Props.Brightness_LevelEmergency = UDS_FrontLight_Properties.Brightness_LevelEmergency;
    CONFIG_Props.Brightness_LevelSafety = UDS_FrontLight_Properties.Brightness_LevelSafety;
    CONFIG_Props.Strobe_LevelLow = UDS_FrontLight_Properties.Strobe_LevelLow;
    CONFIG_Props.Strobe_LevelHigh = UDS_FrontLight_Properties.Strobe_LevelHigh;
    CONFIG_Props.Strobe_ModeDefault = CONFIG_ToStrobeSource(UDS_FrontLight_Properties.Strobe_ModeDefault);
    CONFIG_Props.Strobe_ModePrimary = CONFIG_ToStrobeSource(UDS_FrontLight_Properties.Strobe_ModePrimary);
    CONFIG_Props.Strobe_ModeEmergency = CONFIG_ToStrobeSource(UDS_FrontLight_Properties.Strobe_ModeEmergency);
    CONFIG_Props.Strobe_ModeSafety = CONFIG_ToStrobeSource(UDS_FrontLight_Properties.Strobe_ModeSafety);
    CONFIG_Props.Strobe_SingleOnTime = UDS_FrontLight_Properties.Strobe_SingleOnTime;
    CONFIG_Props.Strobe_SingleOffTime = UDS_FrontLight_Properties.Strobe_SingleOffTime;
    CONFIG_Props.Strobe_RapidOnTime = UDS_FrontLight_Properties.Strobe_RapidOnTime;
    CONFIG_Props.Strobe_RapidOffTime = UDS_FrontLight_Properties.Strobe_RapidOffTime;
}
